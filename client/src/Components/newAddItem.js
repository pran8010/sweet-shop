            ...
            <form className='col-sm-7 m-4 bg-light p-4' onSubmit={this.handleSubmit}>
                ...
                <div className="input-group mb-3">
                    ...
                    <div className="form-file">
                        <input type="file" className="form-file-input" name='image' id="Image" accept='.jpg,.jpeg' aria-describedby="inputGroupFileAddon01" required={updateOrNot} onChange={this.handleChange} />
