...
const DeleteItems = ()=>{
    ...
    return(
        <div className='d-flex align-items-center justify-content-center mb-5'>
            <form className='bg-white p-4 rounded-lg m-1 text-center border border-danger col-md-5'>
            ...
            <div className="input-group input-group btn-ouline-danger">
                ...
                <input type="text" className="form-control" placeholder='Enter ID of a product to delete' onChange={(e)=>setProd_id(e.target.value)} aria-label="delete item" aria-describedby="delete-item-from-DB"/>
            </div>
